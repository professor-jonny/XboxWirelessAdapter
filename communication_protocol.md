...
```
[0x00] HMAC-SHA1: "Redacted copyright"
[0x14] Copyright: "Redacted copyright"
...
```
Key:   "Redacted Copyright"  (g_XPP_HMAC_Key, 16-byte ROM constant)
...
---------------|-------------------------------------------|---------|-----------------------------
MSBNUpdate.exe |  "Redacted copyright"        | 64 bytes| Computing HMAC in WRQ
               |                              |         | filename field (firmware ignores)
Adapter FW     | "Redacted copyright"         | 16 bytes| WRQ auth HMAC verification
...
```
HMAC-SHA1(key=MSBNUpdate_64byte_key, data="admin") = "Redacted copyright"  
    → value in WRQ auth.HMAC field (trialupdate.pcapng frame 32 ✅)

HMAC-SHA1(key=fw_rom_key_16byte,     data="admin") = "Redacted copyright"  
